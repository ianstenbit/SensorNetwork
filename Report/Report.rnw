...
\includegraphics[width=7.5cm, height=7.5cm]{bench1}

\textit{The distribution of points and a backbone for benchmark 1}
...
\includegraphics[width=7.5cm, height=7.5cm]{bench2}

\textit{The distribution of points and a backbone for benchmark 2}
...
\includegraphics[width=7.5cm, height=7.5cm]{bench3}
...
\includegraphics[width=7.5cm, height=7.5cm]{bench6}

\textit{The distribution of points and a backbone for benchmark 6}
...
\includegraphics[width=12cm]{Report-bench7}
 ...
 \includegraphics[width=7.5cm, height=7.5cm]{bench7}
...
\includegraphics[width=7.25cm, height=7.25cm]{bench8}

\textit{The distribution of points and a backbone for benchmark 8}
...
\includegraphics[width=7.25cm, height=7.25cm]{bench9}

\textit{The distribution of points and a backbone for benchmark 9}
